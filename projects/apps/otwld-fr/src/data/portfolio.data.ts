...
export const MESDOCTEURS: PortfolioItem = {
  ...
  services: [TEAM_EXTENSION],
  skills: ['Angular', 'NestJS', 'GraphQL', 'RxJS'],
  startDate: new Date('2021-11-01').getTime(),
  endDate: new Date('2023-02-3').getTime(),
  templates: {
    en: environment.templates.portfolio.mesdocteurs.enURL,
    fr: environment.templates.portfolio.mesdocteurs.frURL,
  },
...
export const ATEME: PortfolioItem = {
  ...
  templates: {
    en: environment.templates.portfolio.ateme.enURL,
    fr: environment.templates.portfolio.ateme.frURL,
  },
...
export const PORTFOLIO_DATA: Portfolio = [
  {
    ...OCC,
    nextProject: ONSTAGE,
    previousProject: JEPRECOMMANDE,
    relatedProjects: [MESDOCTEURS],
  },
  {
    ...ONSTAGE,
    nextProject: JEPRECOMMANDE,
    previousProject: OCC,
    relatedProjects: [JEPRECOMMANDE],
  },
  {
    ...JEPRECOMMANDE,
    nextProject: MESDOCTEURS,
    previousProject: ONSTAGE,
    relatedProjects: [ONSTAGE],
  },
  {
    ...MESDOCTEURS,
    nextProject: ATEME,
    previousProject: JEPRECOMMANDE,
    relatedProjects: [ATEME, JEPRECOMMANDE],
  },
  {
    ...ATEME,
    nextProject: OCC,
    previousProject: MESDOCTEURS,
    relatedProjects: [MESDOCTEURS, JEPRECOMMANDE],
  },
];
