...
import {randFirstName, randImg, randJobTitle, randLastName, randText,} from '@ngneat/falso';
...
export const APAIN_TESTIMONIALS: Testimonial[] = [{
  message: 'Arthur est un collègue avec lequel j\'ai énormément apprécié travailler. ' +
  ...
  message: 'Arthur a rejoint le projet il y a 7 mois pour renforcer notre équipe de développement.' +
